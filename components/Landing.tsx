  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
      <div className="max-w-xl w-full text-center space-y-8">
        ...
        <button
          onClick={onStart}
          className="inline-block bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-semibold text-base px-8 py-3.5 rounded-xl shadow-sm transition-colors duration-150 cursor-pointer"
        >
          Start beginner quiz
        </button>
